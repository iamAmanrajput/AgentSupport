...
(function () {
  ...
  if (!organizationId) {
    console.error(
      "AgentSupport Widget: data-organization-id attribute is required"
    );
    return;
  }
  ...
  function render() {
    ...
    button.id = "agentsupport-widget-button";
    ...
    container.id = "agentsupport-widget-container";
  ...
  function hide() {
    if (container && button) {
      ...
      button.innerHTML = chatBubbleIcon;
      button.style.background = "#069669";
    }
  }
  ...
  (window as any).AgentSupportWidget = {
    init: reinit,
    show,
    hide,
    destroy,
